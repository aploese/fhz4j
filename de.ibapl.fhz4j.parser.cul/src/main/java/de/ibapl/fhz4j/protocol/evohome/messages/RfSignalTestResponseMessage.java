 ...
 * @param <T>
 */
public class RfSignalTestResponseMessage<T extends RfSignalTestResponseMessage<T>> extends EvoHomeDeviceMessage<T> {

    public short value;

    public RfSignalTestResponseMessage(EvoHomeMsgParam0 msgParam0) {
        super(EvoHomeCommand.RF_SIGNAL_TEST, EvoHomeMsgType.RESPONSE, msgParam0);
    }
