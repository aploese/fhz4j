 ...
 * Setpoint Override</a>
 */
public class ZoneSetpointOverrideInformationMessage extends AbstractZoneSetpointOverrideMessage {

    public ZoneSetpointOverrideInformationMessage(EvoHomeMsgParam0 msgParam0) {
