 ...
 * Window Sensor</a>
 */
public class WindowSensorInformationMessage extends AbstractWindowSensorPayloadMessage {

    public WindowSensorInformationMessage(EvoHomeMsgParam0 msgParam0) {
