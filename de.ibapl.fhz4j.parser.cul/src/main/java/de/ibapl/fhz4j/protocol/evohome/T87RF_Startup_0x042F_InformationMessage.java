...
public class T87RF_Startup_0x042F_InformationMessage extends EvoHomeDeviceMessage {
    ...
    public T87RF_Startup_0x042F_InformationMessage(EvoHomeMsgParam0 msgParam0, short length) {
        super(EvoHomeCommand.T87RF_STARTUP_042F, EvoHomeMsgType.INFORMATION, msgParam0);
