 ...
 * @param <T>
 */
public class ControllerModeRequestMessage<T extends ControllerModeRequestMessage<T>> extends AbstractControllerModeMessage<T> {

    public ControllerModeRequestMessage(EvoHomeMsgParam0 msgParam0) {
