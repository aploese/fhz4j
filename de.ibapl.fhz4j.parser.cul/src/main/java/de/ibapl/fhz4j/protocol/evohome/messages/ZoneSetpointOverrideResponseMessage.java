 ...
 * Setpoint Override</a>
 */
public class ZoneSetpointOverrideResponseMessage extends AbstractZoneSetpointOverrideMessage {

    public ZoneSetpointOverrideResponseMessage(EvoHomeMsgParam0 msgParam0) {
