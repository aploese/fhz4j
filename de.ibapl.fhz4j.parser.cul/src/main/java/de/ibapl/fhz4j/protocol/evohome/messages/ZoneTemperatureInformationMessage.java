 ...
 * Zone Temperature</a>
 */
public class ZoneTemperatureInformationMessage extends AbstractZoneTemperaturePayloadMessage {

    public ZoneTemperatureInformationMessage(EvoHomeMsgParam0 msgParam0) {
