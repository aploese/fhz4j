 ...
 * @param <T>
 */
public class LocalizationResponseMessage<T extends LocalizationResponseMessage<T>> extends EvoHomeDeviceMessage<T> {

    public byte unused0;
    public String language;
    public byte unused1;

    public LocalizationResponseMessage(EvoHomeMsgParam0 msgParam0) {
