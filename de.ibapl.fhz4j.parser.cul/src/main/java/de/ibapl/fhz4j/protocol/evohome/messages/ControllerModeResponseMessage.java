 ...
 * @param <T>
 */
public class ControllerModeResponseMessage<T extends ControllerModeResponseMessage<T>> extends AbstractControllerModePayloadMessage<T> {

    public ControllerModeResponseMessage(EvoHomeMsgParam0 msgParam0) {
