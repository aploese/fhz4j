...
public class ZoneManagementInformationMessage<T extends ZoneManagementInformationMessage<T>> extends EvoHomeDeviceMessage<T> {
    ...
    public ZoneManagementInformationMessage(EvoHomeMsgParam0 msgParam0, short length) {
        super(EvoHomeCommand.ZONE_MANAGEMENT, EvoHomeMsgType.INFORMATION, msgParam0);
