 ...
 * Zone Temperature</a>
 */
public class ZoneTemperatureResponseMessage extends AbstractZoneTemperaturePayloadMessage {

    public ZoneTemperatureResponseMessage(EvoHomeMsgParam0 msgParam0) {
