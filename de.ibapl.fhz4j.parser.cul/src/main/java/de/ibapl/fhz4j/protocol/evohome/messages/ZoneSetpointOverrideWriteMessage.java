 ...
 * Setpoint Override</a>
 */
public class ZoneSetpointOverrideWriteMessage extends AbstractZoneSetpointOverrideMessage {

    public ZoneSetpointOverrideWriteMessage(EvoHomeMsgParam0 msgParam0) {
