 ...
 * Setpoint Override</a>
 */
public class ZoneSetpointOverrideRequestMessage extends AbstractZoneSetpointOverrideMessage {

    public ZoneSetpointOverrideRequestMessage(EvoHomeMsgParam0 msgParam0) {
