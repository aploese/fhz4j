 ...
 * Zone Setpoint</a>
 */
public class ZoneSetpointInformationMessage extends AbstractZoneSetpointPayloadMessage {

    public ZoneSetpointInformationMessage(EvoHomeMsgParam0 msgParam0) {
